...
namespace AppMovies
{
    ...
    public partial class Funciones : ContentPage
    {
        ...
        public void readyprox()
        {
            ...
            webview.Source = conexion.dominio + "cartelera.php";
        }
...
var httpClient = new HttpClient();
            ...
            try
            {
                ...
                var response = await httpClient.GetAsync(conexion.dominio + "cartelera.php");
            ...
            {
                await DisplayAlert("Mensaje", "Sin servicio, Intente más tarde /n " + inf.Message, "ok");
                await Application.Current.MainPage.Navigation.PopAsync();
            }
        }
